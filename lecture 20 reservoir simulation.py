# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 16:22:58 2020
...
production_4 = 1000
Q_matrix[0][0]= 1000
Q_matrix[number_nodes-1][0]= Q - production_4
print("\n Q_matrix is\n", str(Q_matrix))
...
N_plus_1_matrix = ( (1 - theta)*transmisibility_matrix + inverse_dt*B_matrix )
...
N__matrix = (inverse_dt*B_matrix - theta*transmisibility_matrix )
